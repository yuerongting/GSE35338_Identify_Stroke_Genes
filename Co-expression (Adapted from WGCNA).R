...
# pdata=pdata[which(pdata$source_name_ch1=='Purified reactive astrocytes 1 day after MCAO-induced stroke'),]
# pdata=pdata[which(pdata$treatment:ch1=='MCAO-induced stroke'),]
